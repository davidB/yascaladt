 ...
 */
public abstract class AbstractYaScalaParser extends Parser {
    /**
     ...
     */
    protected AbstractYaScalaParser(TokenStream input) {
        super(input);
    }
     ...
     */
    protected AbstractYaScalaParser(TokenStream input, RecognizerSharedState state) {
        super(input, state);
    }
