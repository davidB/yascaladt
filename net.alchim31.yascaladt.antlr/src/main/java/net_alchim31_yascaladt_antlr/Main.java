...
import java.io.*;
import net_alchim31_yascaladt_antlr.TParser.a_return;
    ...
    public static void main(String[] args) {
        try {
            ...
            if (args.length > 0) {
                ...
                System.err
                        .println("Usage: java -jar net_alchim31_yascaladt_antlr-0.1-SNAPSHOT-jar-with-dependencies.jar <directory | filename.dmo>");
            }
        } catch (Exception ex) {
