package net_alchim31_yascaladt_antlr;
 ...
 */
public abstract class AbstractYaScalaLexer
    extends Lexer

{
     ...
     */
    public AbstractYaScalaLexer(CharStream input) {
     ...
     */
    public AbstractYaScalaLexer(CharStream input, RecognizerSharedState state) {
        super(input,state);
    }
